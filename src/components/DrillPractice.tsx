...
import { Play, RotateCcw, Volume2, CheckCircle2, Clock, Target, ArrowRight } from 'lucide-react';
...
const DRILL_EXERCISES = [
  { 
    ...
    pitches: [261.63, 293.66, 329.63, 349.23, 392.00, 440.00, 493.88, 523.25], // C4 to C5
    level: 'beginner'
  },
  {
    id: 'perfect-fifth',
    ...
    pitches: [261.63, 392.00], // C4 to G4
    level: 'beginner'
  },
  {
    id: 'chromatic-run',
    ...
    pitches: [261.63, 277.18, 293.66, 311.13, 329.63, 349.23, 369.99, 392.00],
    level: 'intermediate'
  },
  {
    id: 'octave-jump',
...
export default function DrillPractice({ onComplete }: DrillPracticeProps) {
  ...
  const progress = ((currentPitchIndex + 1) / selectedExercise.pitches.length) * 100;
        ...
        <CardContent className="space-y-6">
          {!exerciseStarted ? (
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <ol className="space-y-1 text-sm list-decimal list-inside">
                      <li>Listen to the reference pitch by clicking "Play Reference"</li>
                  ...
                  <div className="pt-4 flex justify-center">
                    <Button onClick={startExercise} size="lg" className="text-lg px-8">
            ...
            <div className="text-center py-8 space-y-6">
              ...
              <div>
                <h3 className="text-3xl font-bold text-green-600 mb-2">Exercise Complete!</h3>
                ...
                <CardContent className="pt-6">
                  <div className="grid grid-cols-2 gap-4 text-center">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Notes Completed</div>
                    </div>
                  </div>
                  {sessionStartTime && (
                    <div className="text-center mt-4 pt-4 border-t">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <span className="text-sm text-gray-600">
                          Session Time: {Math.round((Date.now() - sessionStartTime) / 1000)}s
                        </span>
                      </div>
                    </div>
                  )}
              ...
              <div className="flex gap-4 justify-center">
                <Button onClick={restartExercise} variant="outline">
                  <RotateCcw className="w-4 h-4 mr-2" />
                  Try Again
                </Button>
                <Button 
                  onClick={() => {
                    const nextIndex = (DRILL_EXERCISES.findIndex(e => e.id === selectedExercise.id) + 1) % DRILL_EXERCISES.length;
            ...
            <>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span>Progress</span>
                  <span>{currentPitchIndex + 1} of {selectedExercise.pitches.length}</span>
                </div>
                ...
                <CardContent className="pt-6">
                  <div className="text-center space-y-4">
                    ...
                    <div className="flex gap-2 justify-center">
                      ...
                      <Button onClick={previousPitch} disabled={currentPitchIndex === 0} variant="outline" size="sm">
                        Previous
                      </Button>
                      <Button onClick={nextPitch} variant="outline" size="sm">
                        Skip
                      </Button>
                    </div>
                  </div>
                ...
                <Card className="bg-yellow-50 dark:bg-yellow-900/20">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <p className="text-sm text-gray-600">Jump to any note in this exercise:</p>
                      <div className="flex flex-wrap gap-2">
                        {selectedExercise.pitches.map((pitch, index) => (
                          <Button
                            key={index}
                            variant={index === currentPitchIndex ? 'default' : 'outline'}
                            size="sm"
