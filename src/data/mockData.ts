...
export const mockArtists: Artist[] = [
  {
    ...
    successNotes:
      'Pioneered Cameroonian hip hop on international stage with "Hein Pere". Strong TikTok engagement with dance challenges.',
  },
  {
    id: "2",
    name: "Blanche Bailly",
    ...
    successNotes:
      "Built massive following through high-quality music videos and relatable content. Strong connection with female audience.",
  },
  {
    id: "3",
    name: "Tenor",
    ...
    successNotes:
      "Success through catchy melodies and strategic collaborations with Nigerian artists. Strong Boomplay presence.",
  },
  {
    id: "4",
    name: "Ko-C",
    ...
    successNotes:
      "Mastered both English and French rap. Creates viral moments through relatable street narratives.",
  },
  {
    id: "5",
    name: "Daphne",
    ...
    successNotes:
      "International recognition through powerful vocals and professional brand image. Multiple awards and endorsements.",
  },
  {
    id: "6",
    name: "Salatiel",
    ...
    successNotes:
      "Success as both artist and producer. Beyoncé collaboration brought international spotlight. Focus on quality over quantity.",
  },
  {
    id: "7",
    name: "Locko",
    ...
    successNotes:
      "Built fanbase through emotional love songs and acoustic performances. Regular YouTube releases maintain engagement.",
  },
  {
    id: "8",
    name: "Mr Leo",
    ...
    successNotes:
      "Strong connection with fans through consistent live shows. Versatile style appeals to broad audience.",
  },
  {
    id: "9",
    name: "Montess",
    ...
    successNotes:
      "Rising star leveraging TikTok dance trends. Young demographic connection through relatable content.",
  },
  {
    id: "10",
    name: "Kameni",
    ...
    successNotes:
      "Successfully modernized Makossa for contemporary audience. Strong diaspora following through cultural authenticity.",
  },
];
...
export const recordLabels = [
  ...
  {
    name: "Alpha Better Records",
    region: "Yaounde",
    focus: ["Afro-Pop", "R&B"],
  },
  { name: "Empire Company", region: "Douala", focus: ["Hip Hop", "Afrobeats"] },
  {
    name: "Big Dreams Entertainment",
    region: "Bamenda",
    focus: ["Hip Hop", "Afro-Pop"],
  },
  {
    name: "Stevens Music Entertainment",
    region: "Buea",
    focus: ["Afrobeats", "Afro-Pop"],
  },
];
