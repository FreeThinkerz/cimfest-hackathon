          ...
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-center h-16">
              <Link to="/" className="text-2xl font-bold">
                <div className="inline-flex items-center justify-center w-10 h-10 mr-2 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 mb-4 animate-glow-pulse">
              ...
              <nav className="hidden md:flex space-x-6 items-center">
                ...
                {user?.roles[0] === "artist" && (
                  <Link to="/artist-dashboard/nmd" className="hover:underline">
                    Directory
                  </Link>
                )}
                {user?.roles[0] === "sponsor" && (
                  <Link to="/sponsor-dashboard" className="hover:underline">
                    Sponsor
                  </Link>
                )}
              </nav>
              <div ref={wrapperRef} className="relative">
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48  rounded shadow-lg z-10">
                    <Button
                      onClick={goProfile}
                      className="block w-full text-left px-4 py-2 hover:bg-gray-100 hover:text-foreground"
                    >
                      Profile
                    </Button>
                    <Button
      ...
      <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <section>
          ...
          <p className="text-sm opacity-90">
            Your companion for musical training, practice tracking, and
