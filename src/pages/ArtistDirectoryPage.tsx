        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Discover Cameroon's top and rising artists</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredArtists.map((artist) => (
            <Card
              ...
              onClick={() => navigate(`/nmd/${artist.id}`)}
            >
              <CardHeader>
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-blue-600">{artist.performanceScore}</div>
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-2">
                      <div className="text-sm font-bold text-blue-600">{artist.engagement}%</div>
                      <div className="text-xs text-muted-foreground">Engagement</div>
                    </div>
                    <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-2">
                      <div className="text-sm font-bold text-purple-600">{artist.virality}%</div>
                      <div className="text-xs text-muted-foreground">Virality</div>
                    </div>
                    <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-2">
                      <div className="text-sm font-bold text-green-600">{artist.growth}%</div>
