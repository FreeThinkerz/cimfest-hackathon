...
export default function LabelDashboardPage() {
  ...
  const artistsWithTalent = mockArtists.map((artist) => ({
    ...
    level: ['basic', 'intermediate', 'advanced'][Math.floor(Math.random() * 3)] as 'basic' | 'intermediate' | 'advanced',
    strengthBadge: ['Pitch', 'Rhythm', 'Melody', 'Harmony'][Math.floor(Math.random() * 4)],
  }));
      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-600">{filteredArtists.length}</div>
            ...
            <CardContent className="pt-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600">
                  {filteredArtists.filter((a) => a.level === 'advanced').length}
                </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">High Scores (85+)</div>
              </div>
            </CardContent>
          </Card>
          <Card>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-4">
            {sortBy === 'score' ? 'Top 5 High-Performing Artists' : 'Artists by Level'}
          </h2>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-2xl font-bold text-orange-600">{artist.talentScore}</span>
                    </div>

                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 text-center">
                        <div className="text-sm font-bold text-blue-600">{artist.performanceScore}</div>
                        <div className="text-xs text-muted-foreground">Performance</div>
                      </div>
                      <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-3 text-center">
                        <div className="text-sm font-bold text-purple-600 capitalize">{artist.strengthBadge}</div>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>Connect artists with experienced mentors</CardDescription>
                </div>
              </div>
            </CardHeader>
          </Card>

          <Card className="hover:shadow-lg transition-all cursor-pointer" onClick={() => navigate('/nmd')}>
            <CardHeader>
              <div className="flex items-center gap-3">
                <Building2 className="w-8 h-8 text-orange-600" />
                <div>
                  <CardTitle>National Music Database</CardTitle>
                  <CardDescription>Explore the full artist directory</CardDescription>
                </div>
              </div>
            </CardHeader>
          </Card>
