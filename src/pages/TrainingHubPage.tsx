          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <CardTitle className="text-3xl mb-2">AI Music Training Hub</CardTitle>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>See your AI-powered analysis</CardDescription>
                </div>
              </div>
            </CardHeader>
          </Card>

          <Card className="hover:shadow-lg transition-all cursor-pointer" onClick={() => navigate('/training/level-progression')}>
            <CardHeader>
              <div className="flex items-center gap-3">
                <Brain className="w-8 h-8 text-purple-600" />
                <div>
                  <CardTitle>Level Progression</CardTitle>
                  <CardDescription>Check your advancement status</CardDescription>
                </div>
              </div>
            </CardHeader>
          </Card>
